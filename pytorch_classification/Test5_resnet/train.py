...
def main():
    ...
    data_transform = {
        ...
        "test": transforms.Compose([transforms.Resize(256),  # 长宽比固定，最小边缩放到256
    ...
    net = resnet50()  # 没有传入num_classes参数，实例化之后，全连接层有1000个节点（1000分类）
    model_weight_path = "./resnet50-19c8e357.pth"
    missing_keys, unexpected_keys = net.load_state_dict(torch.load(model_weight_path), strict=False)
    in_channel = net.fc.in_features  # 输入特征矩阵的深度
    net.fc = nn.Linear(in_channel, 3)  # 全连接层，重新复制全连接层
    net.to(device)
